...
while (~isempty(strfind(src_file,'op_par_loop_3')))
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  loc  = min(strfind(src_file,'op_par_loop_3'));
  src_file = src_file(loc:end);

  [foo,  src_file] = strtok(src_file,'(');
...
'                                                                                      ',... 
'void op_decl_dat(op_set set,int dm,op_datatype type,double *dat,op_dat &dt,char const *nm){',...
'    op_decl_ddat(       set,    dm,            type,        dat,        dt,            nm);',...
'}                                                                                     ',... 
'                                                                                      ',... 
'void op_decl_dat(op_set set,int dim,op_datatype type,float *dat,op_dat &dt,char const *nm){',...
'    op_decl_fdat(       set,    dim,            type,       dat,        dt,            nm);',...
'}                                                                                     ',... 
'                                                                                      ',... 
'void op_decl_dat(op_set set,int dim,op_datatype type,int *dat,op_dat &data,char const *nm){',...
'    op_decl_idat(       set,    dim,            type,     dat,        data,            nm);',...
'}                                                                                     ',... 
'                                                                                      ',...  
'extern "C"                                                                            ',... 
