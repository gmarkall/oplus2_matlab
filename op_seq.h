// 
// auto-generated by op_seq_gen.m on 06-Sep-2010 11:34:50 
//
...
void op_par_loop_1(void (*kernel)( T0* ),                                                
  ...
  D0  arg0 ,int idx0 ,op_ptr ptr0 ,int dim0 ,const char *typ0 ,op_access acc0 ){         
...
void op_par_loop_2(void (*kernel)( T0*, T1* ),                                           
  char const * name, op_set set,                                                         
  D0  arg0 ,int idx0 ,op_ptr ptr0 ,int dim0 ,const char *typ0 ,op_access acc0 ,          
  D1  arg1 ,int idx1 ,op_ptr ptr1 ,int dim1 ,const char *typ1 ,op_access acc1 ){         
...
void op_par_loop_3(void (*kernel)( T0*, T1*, T2* ),                                      
  ...
  D0  arg0 ,int idx0 ,op_ptr ptr0 ,int dim0 ,const char *typ0 ,op_access acc0 ,          
  D1  arg1 ,int idx1 ,op_ptr ptr1 ,int dim1 ,const char *typ1 ,op_access acc1 ,          
  D2  arg2 ,int idx2 ,op_ptr ptr2 ,int dim2 ,const char *typ2 ,op_access acc2 ){         
...
void op_par_loop_4(void (*kernel)( T0*, T1*, T2*, T3* ),                                 
  ...
  D1  arg1 ,int idx1 ,op_ptr ptr1 ,int dim1 ,const char *typ1 ,op_access acc1 ,          
  D2  arg2 ,int idx2 ,op_ptr ptr2 ,int dim2 ,const char *typ2 ,op_access acc2 ,          
  D3  arg3 ,int idx3 ,op_ptr ptr3 ,int dim3 ,const char *typ3 ,op_access acc3 ){         
...
void op_par_loop_5(void (*kernel)( T0*, T1*, T2*, T3*, T4* ),                            
  ...
  D2  arg2 ,int idx2 ,op_ptr ptr2 ,int dim2 ,const char *typ2 ,op_access acc2 ,          
  D3  arg3 ,int idx3 ,op_ptr ptr3 ,int dim3 ,const char *typ3 ,op_access acc3 ,          
  D4  arg4 ,int idx4 ,op_ptr ptr4 ,int dim4 ,const char *typ4 ,op_access acc4 ){         
...
void op_par_loop_6(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D3  arg3 ,int idx3 ,op_ptr ptr3 ,int dim3 ,const char *typ3 ,op_access acc3 ,          
  D4  arg4 ,int idx4 ,op_ptr ptr4 ,int dim4 ,const char *typ4 ,op_access acc4 ,          
  D5  arg5 ,int idx5 ,op_ptr ptr5 ,int dim5 ,const char *typ5 ,op_access acc5 ){         
...
void op_par_loop_7(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D4  arg4 ,int idx4 ,op_ptr ptr4 ,int dim4 ,const char *typ4 ,op_access acc4 ,          
  D5  arg5 ,int idx5 ,op_ptr ptr5 ,int dim5 ,const char *typ5 ,op_access acc5 ,          
  D6  arg6 ,int idx6 ,op_ptr ptr6 ,int dim6 ,const char *typ6 ,op_access acc6 ){         
...
void op_par_loop_8(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D5  arg5 ,int idx5 ,op_ptr ptr5 ,int dim5 ,const char *typ5 ,op_access acc5 ,          
  D6  arg6 ,int idx6 ,op_ptr ptr6 ,int dim6 ,const char *typ6 ,op_access acc6 ,          
  D7  arg7 ,int idx7 ,op_ptr ptr7 ,int dim7 ,const char *typ7 ,op_access acc7 ){         
...
void op_par_loop_9(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D6  arg6 ,int idx6 ,op_ptr ptr6 ,int dim6 ,const char *typ6 ,op_access acc6 ,          
  D7  arg7 ,int idx7 ,op_ptr ptr7 ,int dim7 ,const char *typ7 ,op_access acc7 ,          
  D8  arg8 ,int idx8 ,op_ptr ptr8 ,int dim8 ,const char *typ8 ,op_access acc8 ){         
...
void op_par_loop_10(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D7  arg7 ,int idx7 ,op_ptr ptr7 ,int dim7 ,const char *typ7 ,op_access acc7 ,          
  D8  arg8 ,int idx8 ,op_ptr ptr8 ,int dim8 ,const char *typ8 ,op_access acc8 ,          
  D9  arg9 ,int idx9 ,op_ptr ptr9 ,int dim9 ,const char *typ9 ,op_access acc9 ){         
...
void op_par_loop_11(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D8  arg8 ,int idx8 ,op_ptr ptr8 ,int dim8 ,const char *typ8 ,op_access acc8 ,          
  D9  arg9 ,int idx9 ,op_ptr ptr9 ,int dim9 ,const char *typ9 ,op_access acc9 ,          
  D10 arg10,int idx10,op_ptr ptr10,int dim10,const char *typ10,op_access acc10){         
...
void op_par_loop_12(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D9  arg9 ,int idx9 ,op_ptr ptr9 ,int dim9 ,const char *typ9 ,op_access acc9 ,          
  D10 arg10,int idx10,op_ptr ptr10,int dim10,const char *typ10,op_access acc10,          
  D11 arg11,int idx11,op_ptr ptr11,int dim11,const char *typ11,op_access acc11){         
...
void op_par_loop_13(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D10 arg10,int idx10,op_ptr ptr10,int dim10,const char *typ10,op_access acc10,          
  D11 arg11,int idx11,op_ptr ptr11,int dim11,const char *typ11,op_access acc11,          
  D12 arg12,int idx12,op_ptr ptr12,int dim12,const char *typ12,op_access acc12){         
...
void op_par_loop_14(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D11 arg11,int idx11,op_ptr ptr11,int dim11,const char *typ11,op_access acc11,          
  D12 arg12,int idx12,op_ptr ptr12,int dim12,const char *typ12,op_access acc12,          
  D13 arg13,int idx13,op_ptr ptr13,int dim13,const char *typ13,op_access acc13){         
...
void op_par_loop_15(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D12 arg12,int idx12,op_ptr ptr12,int dim12,const char *typ12,op_access acc12,          
  D13 arg13,int idx13,op_ptr ptr13,int dim13,const char *typ13,op_access acc13,          
  D14 arg14,int idx14,op_ptr ptr14,int dim14,const char *typ14,op_access acc14){         
...
void op_par_loop_16(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D13 arg13,int idx13,op_ptr ptr13,int dim13,const char *typ13,op_access acc13,          
  D14 arg14,int idx14,op_ptr ptr14,int dim14,const char *typ14,op_access acc14,          
  D15 arg15,int idx15,op_ptr ptr15,int dim15,const char *typ15,op_access acc15){         
...
void op_par_loop_17(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D14 arg14,int idx14,op_ptr ptr14,int dim14,const char *typ14,op_access acc14,          
  D15 arg15,int idx15,op_ptr ptr15,int dim15,const char *typ15,op_access acc15,          
  D16 arg16,int idx16,op_ptr ptr16,int dim16,const char *typ16,op_access acc16){         
...
void op_par_loop_18(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D15 arg15,int idx15,op_ptr ptr15,int dim15,const char *typ15,op_access acc15,          
  D16 arg16,int idx16,op_ptr ptr16,int dim16,const char *typ16,op_access acc16,          
  D17 arg17,int idx17,op_ptr ptr17,int dim17,const char *typ17,op_access acc17){         
...
void op_par_loop_19(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D16 arg16,int idx16,op_ptr ptr16,int dim16,const char *typ16,op_access acc16,          
  D17 arg17,int idx17,op_ptr ptr17,int dim17,const char *typ17,op_access acc17,          
  D18 arg18,int idx18,op_ptr ptr18,int dim18,const char *typ18,op_access acc18){         
...
void op_par_loop_20(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D17 arg17,int idx17,op_ptr ptr17,int dim17,const char *typ17,op_access acc17,          
  D18 arg18,int idx18,op_ptr ptr18,int dim18,const char *typ18,op_access acc18,          
  D19 arg19,int idx19,op_ptr ptr19,int dim19,const char *typ19,op_access acc19){         
