...
template < class T, class D >                                                            
void arg_set(int n,D *arg,int idx,op_ptr ptr,int dim,                                    
             op_datatype typ,op_access acc,T **p_arg){                                   
  *p_arg = (T *) arg;                                                                    
}                                                                                        
...
void op_par_loop_1(void (*kernel)( T0* ),                                                
  ...
  D0  arg0 ,int idx0 ,op_ptr ptr0 ,int dim0 ,op_datatype typ0 ,op_access acc0 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    arg_check(set,0 ,name,arg0 ,idx0 ,ptr0 ,dim0 ,typ0 ,acc0 ,(T0  *)p_arg0 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    arg_set(n,arg0 ,idx0 ,ptr0 ,dim0 ,typ0 ,acc0 ,(T0  **)&p_arg0 );                     
...
void op_par_loop_2(void (*kernel)( T0*, T1* ),                                           
  char const * name, op_set set,                                                         
  D0  arg0 ,int idx0 ,op_ptr ptr0 ,int dim0 ,op_datatype typ0 ,op_access acc0 ,          
  D1  arg1 ,int idx1 ,op_ptr ptr1 ,int dim1 ,op_datatype typ1 ,op_access acc1 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    arg_check(set,0 ,name,arg0 ,idx0 ,ptr0 ,dim0 ,typ0 ,acc0 ,(T0  *)p_arg0 ,&ninds);    
    arg_check(set,1 ,name,arg1 ,idx1 ,ptr1 ,dim1 ,typ1 ,acc1 ,(T1  *)p_arg1 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    arg_set(n,arg0 ,idx0 ,ptr0 ,dim0 ,typ0 ,acc0 ,(T0  **)&p_arg0 );                     
    arg_set(n,arg1 ,idx1 ,ptr1 ,dim1 ,typ1 ,acc1 ,(T1  **)&p_arg1 );                     
...
void op_par_loop_3(void (*kernel)( T0*, T1*, T2* ),                                      
  ...
  D0  arg0 ,int idx0 ,op_ptr ptr0 ,int dim0 ,op_datatype typ0 ,op_access acc0 ,          
  D1  arg1 ,int idx1 ,op_ptr ptr1 ,int dim1 ,op_datatype typ1 ,op_access acc1 ,          
  D2  arg2 ,int idx2 ,op_ptr ptr2 ,int dim2 ,op_datatype typ2 ,op_access acc2 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    arg_check(set,0 ,name,arg0 ,idx0 ,ptr0 ,dim0 ,typ0 ,acc0 ,(T0  *)p_arg0 ,&ninds);    
    arg_check(set,1 ,name,arg1 ,idx1 ,ptr1 ,dim1 ,typ1 ,acc1 ,(T1  *)p_arg1 ,&ninds);    
    arg_check(set,2 ,name,arg2 ,idx2 ,ptr2 ,dim2 ,typ2 ,acc2 ,(T2  *)p_arg2 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    arg_set(n,arg0 ,idx0 ,ptr0 ,dim0 ,typ0 ,acc0 ,(T0  **)&p_arg0 );                     
    arg_set(n,arg1 ,idx1 ,ptr1 ,dim1 ,typ1 ,acc1 ,(T1  **)&p_arg1 );                     
    arg_set(n,arg2 ,idx2 ,ptr2 ,dim2 ,typ2 ,acc2 ,(T2  **)&p_arg2 );                     
...
void op_par_loop_4(void (*kernel)( T0*, T1*, T2*, T3* ),                                 
  ...
  D1  arg1 ,int idx1 ,op_ptr ptr1 ,int dim1 ,op_datatype typ1 ,op_access acc1 ,          
  D2  arg2 ,int idx2 ,op_ptr ptr2 ,int dim2 ,op_datatype typ2 ,op_access acc2 ,          
  D3  arg3 ,int idx3 ,op_ptr ptr3 ,int dim3 ,op_datatype typ3 ,op_access acc3 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,1 ,name,arg1 ,idx1 ,ptr1 ,dim1 ,typ1 ,acc1 ,(T1  *)p_arg1 ,&ninds);    
    arg_check(set,2 ,name,arg2 ,idx2 ,ptr2 ,dim2 ,typ2 ,acc2 ,(T2  *)p_arg2 ,&ninds);    
    arg_check(set,3 ,name,arg3 ,idx3 ,ptr3 ,dim3 ,typ3 ,acc3 ,(T3  *)p_arg3 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg1 ,idx1 ,ptr1 ,dim1 ,typ1 ,acc1 ,(T1  **)&p_arg1 );                     
    arg_set(n,arg2 ,idx2 ,ptr2 ,dim2 ,typ2 ,acc2 ,(T2  **)&p_arg2 );                     
    arg_set(n,arg3 ,idx3 ,ptr3 ,dim3 ,typ3 ,acc3 ,(T3  **)&p_arg3 );                     
...
void op_par_loop_5(void (*kernel)( T0*, T1*, T2*, T3*, T4* ),                            
  ...
  D2  arg2 ,int idx2 ,op_ptr ptr2 ,int dim2 ,op_datatype typ2 ,op_access acc2 ,          
  D3  arg3 ,int idx3 ,op_ptr ptr3 ,int dim3 ,op_datatype typ3 ,op_access acc3 ,          
  D4  arg4 ,int idx4 ,op_ptr ptr4 ,int dim4 ,op_datatype typ4 ,op_access acc4 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,2 ,name,arg2 ,idx2 ,ptr2 ,dim2 ,typ2 ,acc2 ,(T2  *)p_arg2 ,&ninds);    
    arg_check(set,3 ,name,arg3 ,idx3 ,ptr3 ,dim3 ,typ3 ,acc3 ,(T3  *)p_arg3 ,&ninds);    
    arg_check(set,4 ,name,arg4 ,idx4 ,ptr4 ,dim4 ,typ4 ,acc4 ,(T4  *)p_arg4 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg2 ,idx2 ,ptr2 ,dim2 ,typ2 ,acc2 ,(T2  **)&p_arg2 );                     
    arg_set(n,arg3 ,idx3 ,ptr3 ,dim3 ,typ3 ,acc3 ,(T3  **)&p_arg3 );                     
    arg_set(n,arg4 ,idx4 ,ptr4 ,dim4 ,typ4 ,acc4 ,(T4  **)&p_arg4 );                     
...
void op_par_loop_6(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D3  arg3 ,int idx3 ,op_ptr ptr3 ,int dim3 ,op_datatype typ3 ,op_access acc3 ,          
  D4  arg4 ,int idx4 ,op_ptr ptr4 ,int dim4 ,op_datatype typ4 ,op_access acc4 ,          
  D5  arg5 ,int idx5 ,op_ptr ptr5 ,int dim5 ,op_datatype typ5 ,op_access acc5 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,3 ,name,arg3 ,idx3 ,ptr3 ,dim3 ,typ3 ,acc3 ,(T3  *)p_arg3 ,&ninds);    
    arg_check(set,4 ,name,arg4 ,idx4 ,ptr4 ,dim4 ,typ4 ,acc4 ,(T4  *)p_arg4 ,&ninds);    
    arg_check(set,5 ,name,arg5 ,idx5 ,ptr5 ,dim5 ,typ5 ,acc5 ,(T5  *)p_arg5 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg3 ,idx3 ,ptr3 ,dim3 ,typ3 ,acc3 ,(T3  **)&p_arg3 );                     
    arg_set(n,arg4 ,idx4 ,ptr4 ,dim4 ,typ4 ,acc4 ,(T4  **)&p_arg4 );                     
    arg_set(n,arg5 ,idx5 ,ptr5 ,dim5 ,typ5 ,acc5 ,(T5  **)&p_arg5 );                     
...
void op_par_loop_7(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D4  arg4 ,int idx4 ,op_ptr ptr4 ,int dim4 ,op_datatype typ4 ,op_access acc4 ,          
  D5  arg5 ,int idx5 ,op_ptr ptr5 ,int dim5 ,op_datatype typ5 ,op_access acc5 ,          
  D6  arg6 ,int idx6 ,op_ptr ptr6 ,int dim6 ,op_datatype typ6 ,op_access acc6 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,4 ,name,arg4 ,idx4 ,ptr4 ,dim4 ,typ4 ,acc4 ,(T4  *)p_arg4 ,&ninds);    
    arg_check(set,5 ,name,arg5 ,idx5 ,ptr5 ,dim5 ,typ5 ,acc5 ,(T5  *)p_arg5 ,&ninds);    
    arg_check(set,6 ,name,arg6 ,idx6 ,ptr6 ,dim6 ,typ6 ,acc6 ,(T6  *)p_arg6 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg4 ,idx4 ,ptr4 ,dim4 ,typ4 ,acc4 ,(T4  **)&p_arg4 );                     
    arg_set(n,arg5 ,idx5 ,ptr5 ,dim5 ,typ5 ,acc5 ,(T5  **)&p_arg5 );                     
    arg_set(n,arg6 ,idx6 ,ptr6 ,dim6 ,typ6 ,acc6 ,(T6  **)&p_arg6 );                     
...
void op_par_loop_8(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D5  arg5 ,int idx5 ,op_ptr ptr5 ,int dim5 ,op_datatype typ5 ,op_access acc5 ,          
  D6  arg6 ,int idx6 ,op_ptr ptr6 ,int dim6 ,op_datatype typ6 ,op_access acc6 ,          
  D7  arg7 ,int idx7 ,op_ptr ptr7 ,int dim7 ,op_datatype typ7 ,op_access acc7 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,5 ,name,arg5 ,idx5 ,ptr5 ,dim5 ,typ5 ,acc5 ,(T5  *)p_arg5 ,&ninds);    
    arg_check(set,6 ,name,arg6 ,idx6 ,ptr6 ,dim6 ,typ6 ,acc6 ,(T6  *)p_arg6 ,&ninds);    
    arg_check(set,7 ,name,arg7 ,idx7 ,ptr7 ,dim7 ,typ7 ,acc7 ,(T7  *)p_arg7 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg5 ,idx5 ,ptr5 ,dim5 ,typ5 ,acc5 ,(T5  **)&p_arg5 );                     
    arg_set(n,arg6 ,idx6 ,ptr6 ,dim6 ,typ6 ,acc6 ,(T6  **)&p_arg6 );                     
    arg_set(n,arg7 ,idx7 ,ptr7 ,dim7 ,typ7 ,acc7 ,(T7  **)&p_arg7 );                     
...
void op_par_loop_9(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  D6  arg6 ,int idx6 ,op_ptr ptr6 ,int dim6 ,op_datatype typ6 ,op_access acc6 ,          
  D7  arg7 ,int idx7 ,op_ptr ptr7 ,int dim7 ,op_datatype typ7 ,op_access acc7 ,          
  D8  arg8 ,int idx8 ,op_ptr ptr8 ,int dim8 ,op_datatype typ8 ,op_access acc8 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,6 ,name,arg6 ,idx6 ,ptr6 ,dim6 ,typ6 ,acc6 ,(T6  *)p_arg6 ,&ninds);    
    arg_check(set,7 ,name,arg7 ,idx7 ,ptr7 ,dim7 ,typ7 ,acc7 ,(T7  *)p_arg7 ,&ninds);    
    arg_check(set,8 ,name,arg8 ,idx8 ,ptr8 ,dim8 ,typ8 ,acc8 ,(T8  *)p_arg8 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg6 ,idx6 ,ptr6 ,dim6 ,typ6 ,acc6 ,(T6  **)&p_arg6 );                     
    arg_set(n,arg7 ,idx7 ,ptr7 ,dim7 ,typ7 ,acc7 ,(T7  **)&p_arg7 );                     
    arg_set(n,arg8 ,idx8 ,ptr8 ,dim8 ,typ8 ,acc8 ,(T8  **)&p_arg8 );                     
...
void op_par_loop_10(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D7  arg7 ,int idx7 ,op_ptr ptr7 ,int dim7 ,op_datatype typ7 ,op_access acc7 ,          
  D8  arg8 ,int idx8 ,op_ptr ptr8 ,int dim8 ,op_datatype typ8 ,op_access acc8 ,          
  D9  arg9 ,int idx9 ,op_ptr ptr9 ,int dim9 ,op_datatype typ9 ,op_access acc9 ){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,7 ,name,arg7 ,idx7 ,ptr7 ,dim7 ,typ7 ,acc7 ,(T7  *)p_arg7 ,&ninds);    
    arg_check(set,8 ,name,arg8 ,idx8 ,ptr8 ,dim8 ,typ8 ,acc8 ,(T8  *)p_arg8 ,&ninds);    
    arg_check(set,9 ,name,arg9 ,idx9 ,ptr9 ,dim9 ,typ9 ,acc9 ,(T9  *)p_arg9 ,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg7 ,idx7 ,ptr7 ,dim7 ,typ7 ,acc7 ,(T7  **)&p_arg7 );                     
    arg_set(n,arg8 ,idx8 ,ptr8 ,dim8 ,typ8 ,acc8 ,(T8  **)&p_arg8 );                     
    arg_set(n,arg9 ,idx9 ,ptr9 ,dim9 ,typ9 ,acc9 ,(T9  **)&p_arg9 );                     
...
void op_par_loop_11(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D8  arg8 ,int idx8 ,op_ptr ptr8 ,int dim8 ,op_datatype typ8 ,op_access acc8 ,          
  D9  arg9 ,int idx9 ,op_ptr ptr9 ,int dim9 ,op_datatype typ9 ,op_access acc9 ,          
  D10 arg10,int idx10,op_ptr ptr10,int dim10,op_datatype typ10,op_access acc10){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,8 ,name,arg8 ,idx8 ,ptr8 ,dim8 ,typ8 ,acc8 ,(T8  *)p_arg8 ,&ninds);    
    arg_check(set,9 ,name,arg9 ,idx9 ,ptr9 ,dim9 ,typ9 ,acc9 ,(T9  *)p_arg9 ,&ninds);    
    arg_check(set,10,name,arg10,idx10,ptr10,dim10,typ10,acc10,(T10 *)p_arg10,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg8 ,idx8 ,ptr8 ,dim8 ,typ8 ,acc8 ,(T8  **)&p_arg8 );                     
    arg_set(n,arg9 ,idx9 ,ptr9 ,dim9 ,typ9 ,acc9 ,(T9  **)&p_arg9 );                     
    arg_set(n,arg10,idx10,ptr10,dim10,typ10,acc10,(T10 **)&p_arg10);                     
...
void op_par_loop_12(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D9  arg9 ,int idx9 ,op_ptr ptr9 ,int dim9 ,op_datatype typ9 ,op_access acc9 ,          
  D10 arg10,int idx10,op_ptr ptr10,int dim10,op_datatype typ10,op_access acc10,          
  D11 arg11,int idx11,op_ptr ptr11,int dim11,op_datatype typ11,op_access acc11){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,9 ,name,arg9 ,idx9 ,ptr9 ,dim9 ,typ9 ,acc9 ,(T9  *)p_arg9 ,&ninds);    
    arg_check(set,10,name,arg10,idx10,ptr10,dim10,typ10,acc10,(T10 *)p_arg10,&ninds);    
    arg_check(set,11,name,arg11,idx11,ptr11,dim11,typ11,acc11,(T11 *)p_arg11,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg9 ,idx9 ,ptr9 ,dim9 ,typ9 ,acc9 ,(T9  **)&p_arg9 );                     
    arg_set(n,arg10,idx10,ptr10,dim10,typ10,acc10,(T10 **)&p_arg10);                     
    arg_set(n,arg11,idx11,ptr11,dim11,typ11,acc11,(T11 **)&p_arg11);                     
...
void op_par_loop_13(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D10 arg10,int idx10,op_ptr ptr10,int dim10,op_datatype typ10,op_access acc10,          
  D11 arg11,int idx11,op_ptr ptr11,int dim11,op_datatype typ11,op_access acc11,          
  D12 arg12,int idx12,op_ptr ptr12,int dim12,op_datatype typ12,op_access acc12){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,10,name,arg10,idx10,ptr10,dim10,typ10,acc10,(T10 *)p_arg10,&ninds);    
    arg_check(set,11,name,arg11,idx11,ptr11,dim11,typ11,acc11,(T11 *)p_arg11,&ninds);    
    arg_check(set,12,name,arg12,idx12,ptr12,dim12,typ12,acc12,(T12 *)p_arg12,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg10,idx10,ptr10,dim10,typ10,acc10,(T10 **)&p_arg10);                     
    arg_set(n,arg11,idx11,ptr11,dim11,typ11,acc11,(T11 **)&p_arg11);                     
    arg_set(n,arg12,idx12,ptr12,dim12,typ12,acc12,(T12 **)&p_arg12);                     
...
void op_par_loop_14(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D11 arg11,int idx11,op_ptr ptr11,int dim11,op_datatype typ11,op_access acc11,          
  D12 arg12,int idx12,op_ptr ptr12,int dim12,op_datatype typ12,op_access acc12,          
  D13 arg13,int idx13,op_ptr ptr13,int dim13,op_datatype typ13,op_access acc13){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,11,name,arg11,idx11,ptr11,dim11,typ11,acc11,(T11 *)p_arg11,&ninds);    
    arg_check(set,12,name,arg12,idx12,ptr12,dim12,typ12,acc12,(T12 *)p_arg12,&ninds);    
    arg_check(set,13,name,arg13,idx13,ptr13,dim13,typ13,acc13,(T13 *)p_arg13,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg11,idx11,ptr11,dim11,typ11,acc11,(T11 **)&p_arg11);                     
    arg_set(n,arg12,idx12,ptr12,dim12,typ12,acc12,(T12 **)&p_arg12);                     
    arg_set(n,arg13,idx13,ptr13,dim13,typ13,acc13,(T13 **)&p_arg13);                     
...
void op_par_loop_15(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D12 arg12,int idx12,op_ptr ptr12,int dim12,op_datatype typ12,op_access acc12,          
  D13 arg13,int idx13,op_ptr ptr13,int dim13,op_datatype typ13,op_access acc13,          
  D14 arg14,int idx14,op_ptr ptr14,int dim14,op_datatype typ14,op_access acc14){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,12,name,arg12,idx12,ptr12,dim12,typ12,acc12,(T12 *)p_arg12,&ninds);    
    arg_check(set,13,name,arg13,idx13,ptr13,dim13,typ13,acc13,(T13 *)p_arg13,&ninds);    
    arg_check(set,14,name,arg14,idx14,ptr14,dim14,typ14,acc14,(T14 *)p_arg14,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg12,idx12,ptr12,dim12,typ12,acc12,(T12 **)&p_arg12);                     
    arg_set(n,arg13,idx13,ptr13,dim13,typ13,acc13,(T13 **)&p_arg13);                     
    arg_set(n,arg14,idx14,ptr14,dim14,typ14,acc14,(T14 **)&p_arg14);                     
...
void op_par_loop_16(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D13 arg13,int idx13,op_ptr ptr13,int dim13,op_datatype typ13,op_access acc13,          
  D14 arg14,int idx14,op_ptr ptr14,int dim14,op_datatype typ14,op_access acc14,          
  D15 arg15,int idx15,op_ptr ptr15,int dim15,op_datatype typ15,op_access acc15){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,13,name,arg13,idx13,ptr13,dim13,typ13,acc13,(T13 *)p_arg13,&ninds);    
    arg_check(set,14,name,arg14,idx14,ptr14,dim14,typ14,acc14,(T14 *)p_arg14,&ninds);    
    arg_check(set,15,name,arg15,idx15,ptr15,dim15,typ15,acc15,(T15 *)p_arg15,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg13,idx13,ptr13,dim13,typ13,acc13,(T13 **)&p_arg13);                     
    arg_set(n,arg14,idx14,ptr14,dim14,typ14,acc14,(T14 **)&p_arg14);                     
    arg_set(n,arg15,idx15,ptr15,dim15,typ15,acc15,(T15 **)&p_arg15);                     
...
void op_par_loop_17(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D14 arg14,int idx14,op_ptr ptr14,int dim14,op_datatype typ14,op_access acc14,          
  D15 arg15,int idx15,op_ptr ptr15,int dim15,op_datatype typ15,op_access acc15,          
  D16 arg16,int idx16,op_ptr ptr16,int dim16,op_datatype typ16,op_access acc16){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,14,name,arg14,idx14,ptr14,dim14,typ14,acc14,(T14 *)p_arg14,&ninds);    
    arg_check(set,15,name,arg15,idx15,ptr15,dim15,typ15,acc15,(T15 *)p_arg15,&ninds);    
    arg_check(set,16,name,arg16,idx16,ptr16,dim16,typ16,acc16,(T16 *)p_arg16,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg14,idx14,ptr14,dim14,typ14,acc14,(T14 **)&p_arg14);                     
    arg_set(n,arg15,idx15,ptr15,dim15,typ15,acc15,(T15 **)&p_arg15);                     
    arg_set(n,arg16,idx16,ptr16,dim16,typ16,acc16,(T16 **)&p_arg16);                     
...
void op_par_loop_18(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D15 arg15,int idx15,op_ptr ptr15,int dim15,op_datatype typ15,op_access acc15,          
  D16 arg16,int idx16,op_ptr ptr16,int dim16,op_datatype typ16,op_access acc16,          
  D17 arg17,int idx17,op_ptr ptr17,int dim17,op_datatype typ17,op_access acc17){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,15,name,arg15,idx15,ptr15,dim15,typ15,acc15,(T15 *)p_arg15,&ninds);    
    arg_check(set,16,name,arg16,idx16,ptr16,dim16,typ16,acc16,(T16 *)p_arg16,&ninds);    
    arg_check(set,17,name,arg17,idx17,ptr17,dim17,typ17,acc17,(T17 *)p_arg17,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg15,idx15,ptr15,dim15,typ15,acc15,(T15 **)&p_arg15);                     
    arg_set(n,arg16,idx16,ptr16,dim16,typ16,acc16,(T16 **)&p_arg16);                     
    arg_set(n,arg17,idx17,ptr17,dim17,typ17,acc17,(T17 **)&p_arg17);                     
...
void op_par_loop_19(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D16 arg16,int idx16,op_ptr ptr16,int dim16,op_datatype typ16,op_access acc16,          
  D17 arg17,int idx17,op_ptr ptr17,int dim17,op_datatype typ17,op_access acc17,          
  D18 arg18,int idx18,op_ptr ptr18,int dim18,op_datatype typ18,op_access acc18){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,16,name,arg16,idx16,ptr16,dim16,typ16,acc16,(T16 *)p_arg16,&ninds);    
    arg_check(set,17,name,arg17,idx17,ptr17,dim17,typ17,acc17,(T17 *)p_arg17,&ninds);    
    arg_check(set,18,name,arg18,idx18,ptr18,dim18,typ18,acc18,(T18 *)p_arg18,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg16,idx16,ptr16,dim16,typ16,acc16,(T16 **)&p_arg16);                     
    arg_set(n,arg17,idx17,ptr17,dim17,typ17,acc17,(T17 **)&p_arg17);                     
    arg_set(n,arg18,idx18,ptr18,dim18,typ18,acc18,(T18 **)&p_arg18);                     
...
void op_par_loop_20(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  D17 arg17,int idx17,op_ptr ptr17,int dim17,op_datatype typ17,op_access acc17,          
  D18 arg18,int idx18,op_ptr ptr18,int dim18,op_datatype typ18,op_access acc18,          
  D19 arg19,int idx19,op_ptr ptr19,int dim19,op_datatype typ19,op_access acc19){         
  ...
  if (OP_DIAGS>0) {                                                                      
    ...
    arg_check(set,17,name,arg17,idx17,ptr17,dim17,typ17,acc17,(T17 *)p_arg17,&ninds);    
    arg_check(set,18,name,arg18,idx18,ptr18,dim18,typ18,acc18,(T18 *)p_arg18,&ninds);    
    arg_check(set,19,name,arg19,idx19,ptr19,dim19,typ19,acc19,(T19 *)p_arg19,&ninds);    
  }                                                                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg17,idx17,ptr17,dim17,typ17,acc17,(T17 **)&p_arg17);                     
    arg_set(n,arg18,idx18,ptr18,dim18,typ18,acc18,(T18 **)&p_arg18);                     
    arg_set(n,arg19,idx19,ptr19,dim19,typ19,acc19,(T19 **)&p_arg19);                     
