// 
// auto-generated by op_seq_gen.m on 06-Apr-2010 12:35:46 
//
...
void op_par_loop_1(void (*kernel)( T0* ),                                                
  ...
  for (int n=0; n<set.size; n++) {                                                       
    arg_set(n,arg0,idx0,ptr0,dim0,typ0,acc0, &p_arg0);                                   
...
void op_par_loop_2(void (*kernel)( T0*, T1* ),                                           
  ...
  for (int n=0; n<set.size; n++) {                                                       
    arg_set(n,arg0,idx0,ptr0,dim0,typ0,acc0, &p_arg0);                                   
    arg_set(n,arg1,idx1,ptr1,dim1,typ1,acc1, &p_arg1);                                   
...
void op_par_loop_3(void (*kernel)( T0*, T1*, T2* ),                                      
  ...
  for (int n=0; n<set.size; n++) {                                                       
    arg_set(n,arg0,idx0,ptr0,dim0,typ0,acc0, &p_arg0);                                   
    arg_set(n,arg1,idx1,ptr1,dim1,typ1,acc1, &p_arg1);                                   
    arg_set(n,arg2,idx2,ptr2,dim2,typ2,acc2, &p_arg2);                                   
...
void op_par_loop_4(void (*kernel)( T0*, T1*, T2*, T3* ),                                 
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg1,idx1,ptr1,dim1,typ1,acc1, &p_arg1);                                   
    arg_set(n,arg2,idx2,ptr2,dim2,typ2,acc2, &p_arg2);                                   
    arg_set(n,arg3,idx3,ptr3,dim3,typ3,acc3, &p_arg3);                                   
...
void op_par_loop_5(void (*kernel)( T0*, T1*, T2*, T3*, T4* ),                            
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg2,idx2,ptr2,dim2,typ2,acc2, &p_arg2);                                   
    arg_set(n,arg3,idx3,ptr3,dim3,typ3,acc3, &p_arg3);                                   
    arg_set(n,arg4,idx4,ptr4,dim4,typ4,acc4, &p_arg4);                                   
...
void op_par_loop_6(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg3,idx3,ptr3,dim3,typ3,acc3, &p_arg3);                                   
    arg_set(n,arg4,idx4,ptr4,dim4,typ4,acc4, &p_arg4);                                   
    arg_set(n,arg5,idx5,ptr5,dim5,typ5,acc5, &p_arg5);                                   
...
void op_par_loop_7(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg4,idx4,ptr4,dim4,typ4,acc4, &p_arg4);                                   
    arg_set(n,arg5,idx5,ptr5,dim5,typ5,acc5, &p_arg5);                                   
    arg_set(n,arg6,idx6,ptr6,dim6,typ6,acc6, &p_arg6);                                   
...
void op_par_loop_8(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg5,idx5,ptr5,dim5,typ5,acc5, &p_arg5);                                   
    arg_set(n,arg6,idx6,ptr6,dim6,typ6,acc6, &p_arg6);                                   
    arg_set(n,arg7,idx7,ptr7,dim7,typ7,acc7, &p_arg7);                                   
...
void op_par_loop_9(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                              
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg6,idx6,ptr6,dim6,typ6,acc6, &p_arg6);                                   
    arg_set(n,arg7,idx7,ptr7,dim7,typ7,acc7, &p_arg7);                                   
    arg_set(n,arg8,idx8,ptr8,dim8,typ8,acc8, &p_arg8);                                   
...
void op_par_loop_10(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg7,idx7,ptr7,dim7,typ7,acc7, &p_arg7);                                   
    arg_set(n,arg8,idx8,ptr8,dim8,typ8,acc8, &p_arg8);                                   
    arg_set(n,arg9,idx9,ptr9,dim9,typ9,acc9, &p_arg9);                                   
...
void op_par_loop_11(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg8,idx8,ptr8,dim8,typ8,acc8, &p_arg8);                                   
    arg_set(n,arg9,idx9,ptr9,dim9,typ9,acc9, &p_arg9);                                   
    arg_set(n,arg10,idx10,ptr10,dim10,typ10,acc10, &p_arg10);                            
...
void op_par_loop_12(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg9,idx9,ptr9,dim9,typ9,acc9, &p_arg9);                                   
    arg_set(n,arg10,idx10,ptr10,dim10,typ10,acc10, &p_arg10);                            
    arg_set(n,arg11,idx11,ptr11,dim11,typ11,acc11, &p_arg11);                            
...
void op_par_loop_13(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg10,idx10,ptr10,dim10,typ10,acc10, &p_arg10);                            
    arg_set(n,arg11,idx11,ptr11,dim11,typ11,acc11, &p_arg11);                            
    arg_set(n,arg12,idx12,ptr12,dim12,typ12,acc12, &p_arg12);                            
...
void op_par_loop_14(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg11,idx11,ptr11,dim11,typ11,acc11, &p_arg11);                            
    arg_set(n,arg12,idx12,ptr12,dim12,typ12,acc12, &p_arg12);                            
    arg_set(n,arg13,idx13,ptr13,dim13,typ13,acc13, &p_arg13);                            
...
void op_par_loop_15(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg12,idx12,ptr12,dim12,typ12,acc12, &p_arg12);                            
    arg_set(n,arg13,idx13,ptr13,dim13,typ13,acc13, &p_arg13);                            
    arg_set(n,arg14,idx14,ptr14,dim14,typ14,acc14, &p_arg14);                            
...
void op_par_loop_16(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg13,idx13,ptr13,dim13,typ13,acc13, &p_arg13);                            
    arg_set(n,arg14,idx14,ptr14,dim14,typ14,acc14, &p_arg14);                            
    arg_set(n,arg15,idx15,ptr15,dim15,typ15,acc15, &p_arg15);                            
...
void op_par_loop_17(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg14,idx14,ptr14,dim14,typ14,acc14, &p_arg14);                            
    arg_set(n,arg15,idx15,ptr15,dim15,typ15,acc15, &p_arg15);                            
    arg_set(n,arg16,idx16,ptr16,dim16,typ16,acc16, &p_arg16);                            
...
void op_par_loop_18(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg15,idx15,ptr15,dim15,typ15,acc15, &p_arg15);                            
    arg_set(n,arg16,idx16,ptr16,dim16,typ16,acc16, &p_arg16);                            
    arg_set(n,arg17,idx17,ptr17,dim17,typ17,acc17, &p_arg17);                            
...
void op_par_loop_19(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg16,idx16,ptr16,dim16,typ16,acc16, &p_arg16);                            
    arg_set(n,arg17,idx17,ptr17,dim17,typ17,acc17, &p_arg17);                            
    arg_set(n,arg18,idx18,ptr18,dim18,typ18,acc18, &p_arg18);                            
...
void op_par_loop_20(void (*kernel)( T0*, T1*, T2*, T3*, T4*,                             
  ...
  for (int n=0; n<set.size; n++) {                                                       
    ...
    arg_set(n,arg17,idx17,ptr17,dim17,typ17,acc17, &p_arg17);                            
    arg_set(n,arg18,idx18,ptr18,dim18,typ18,acc18, &p_arg18);                            
    arg_set(n,arg19,idx19,ptr19,dim19,typ19,acc19, &p_arg19);                            
