...
%
  ...
  for n = 1:nargs
    ...
    line = '    if (idx0 == OP_ALL) {';
    file = strvcat(file,regexprep(line,'0',num(1:2)));
    line = '      if (acc0 == OP_READ || acc0 == OP_RW || acc0 == OP_INC)';
    file = strvcat(file,regexprep(line,'0',num(1:2)));
    line = '        copy_in(n, arg0, map0, dim0, p_arg0);';
    file = strvcat(file,regexprep(line,'0',num(1:2)));
...
%
  ...
  for n = 1:nargs
    ...
    line = '    if (idx0 == OP_ALL)';
    file = strvcat(file,regexprep(line,'0',num(1:2)));
    line = '      if (acc0 == OP_WRITE || acc0 == OP_RW || acc0 == OP_INC)';
    file = strvcat(file,regexprep(line,'0',num(1:2)));
    line = '        copy_out(n, arg0, map0, dim0, p_arg0);';
    file = strvcat(file,regexprep(line,'0',num(1:2)));
  end
